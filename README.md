...
2. Open your favourite shell and change directory to _src_ directory found at _./connect-four/src_
...
4. Run webpack to compile.
   ...
   ```
    ...
    ./build/scripts/main.js  1.23 MB       0  [emitted]  main
        + 190 hidden modules
    ```
5. Install and use some static web server. E.g. install [Superstatic](https://github.com/firebase/superstatic), run 
   
   ```
   superstatic
   ```
   
   at _./connect-four/src_. Shell output may look something like this
